            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.positions = new ArrayList<Integer>(_list106.size);
                int _elem107;
                for (int _i108 = 0; _i108 < _list106.size; ++_i108)
                {
                  _elem107 = iprot.readI32();
                  struct.positions.add(_elem107);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ids = new ArrayList<String>(_list109.size);
                String _elem110;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mixed = new ArrayList<MixedReference>(_list112.size);
                MixedReference _elem113;
                for (int _i114 = 0; _i114 < _list112.size; ++_i114)
                {
                  _elem113 = new MixedReference();
                  _elem113.read(iprot);
                  struct.mixed.add(_elem113);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.positions != null) {
        if (struct.isSetPositions()) {
          oprot.writeFieldBegin(POSITIONS_FIELD_DESC);
          {
            ...
            for (int _iter115 : struct.positions)
            {
      ...
      if (struct.ids != null) {
        if (struct.isSetIds()) {
          oprot.writeFieldBegin(IDS_FIELD_DESC);
          {
            ...
            for (String _iter116 : struct.ids)
            {
      ...
      if (struct.mixed != null) {
        if (struct.isSetMixed()) {
          oprot.writeFieldBegin(MIXED_FIELD_DESC);
          {
            ...
            for (MixedReference _iter117 : struct.mixed)
            {
      ...
      if (struct.isSetPositions()) {
        {
          ...
          for (int _iter118 : struct.positions)
          {
      ...
      if (struct.isSetIds()) {
        {
          ...
          for (String _iter119 : struct.ids)
          {
      ...
      if (struct.isSetMixed()) {
        {
          ...
          for (MixedReference _iter120 : struct.mixed)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.positions = new ArrayList<Integer>(_list121.size);
          int _elem122;
          for (int _i123 = 0; _i123 < _list121.size; ++_i123)
          {
            _elem122 = iprot.readI32();
            struct.positions.add(_elem122);
          }
        }
        struct.setPositionsIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.ids = new ArrayList<String>(_list124.size);
          String _elem125;
          for (int _i126 = 0; _i126 < _list124.size; ++_i126)
          {
            _elem125 = iprot.readString();
            struct.ids.add(_elem125);
          }
        }
        struct.setIdsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.mixed = new ArrayList<MixedReference>(_list127.size);
          MixedReference _elem128;
          for (int _i129 = 0; _i129 < _list127.size; ++_i129)
          {
            _elem128 = new MixedReference();
            _elem128.read(iprot);
            struct.mixed.add(_elem128);
          }
        }
        struct.setMixedIsSet(true);
      }
