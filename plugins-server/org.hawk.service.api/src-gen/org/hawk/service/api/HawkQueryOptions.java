...
public class HawkQueryOptions implements org.apache.thrift.TBase<HawkQueryOptions, HawkQueryOptions._Fields>, java.io.Serializable, Cloneable, Comparable<HawkQueryOptions> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.filePatterns = new ArrayList<String>(_list112.size);
                String _elem113;
                for (int _i114 = 0; _i114 < _list112.size; ++_i114)
                {
                  _elem113 = iprot.readString();
                  struct.filePatterns.add(_elem113);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.effectiveMetamodelIncludes = new HashMap<String,Map<String,Set<String>>>(2*_map115.size);
                String _key116;
                Map<String,Set<String>> _val117;
                for (int _i118 = 0; _i118 < _map115.size; ++_i118)
                {
                  _key116 = iprot.readString();
                  {
                    org.apache.thrift.protocol.TMap _map119 = iprot.readMapBegin();
                    _val117 = new HashMap<String,Set<String>>(2*_map119.size);
                    String _key120;
                    Set<String> _val121;
                    for (int _i122 = 0; _i122 < _map119.size; ++_i122)
                    {
                      _key120 = iprot.readString();
                      {
                        ...
                        _val121 = new HashSet<String>(2*_set123.size);
                        String _elem124;
                  ...
                  struct.effectiveMetamodelIncludes.put(_key116, _val117);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.effectiveMetamodelExcludes = new HashMap<String,Map<String,Set<String>>>(2*_map126.size);
                String _key127;
                Map<String,Set<String>> _val128;
                for (int _i129 = 0; _i129 < _map126.size; ++_i129)
                {
                  _key127 = iprot.readString();
                  {
                    ...
                    _val128 = new HashMap<String,Set<String>>(2*_map130.size);
                    String _key131;
                    Set<String> _val132;
                    for (int _i133 = 0; _i133 < _map130.size; ++_i133)
                    {
                      _key131 = iprot.readString();
                      {
                        ...
                        _val132 = new HashSet<String>(2*_set134.size);
                        String _elem135;
                  ...
                  struct.effectiveMetamodelExcludes.put(_key127, _val128);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.filePatterns != null) {
        if (struct.isSetFilePatterns()) {
          oprot.writeFieldBegin(FILE_PATTERNS_FIELD_DESC);
          {
            ...
            for (String _iter137 : struct.filePatterns)
            {
      ...
      if (struct.effectiveMetamodelIncludes != null) {
        if (struct.isSetEffectiveMetamodelIncludes()) {
          oprot.writeFieldBegin(EFFECTIVE_METAMODEL_INCLUDES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Map<String,Set<String>>> _iter138 : struct.effectiveMetamodelIncludes.entrySet())
            {
              oprot.writeString(_iter138.getKey());
              {
                oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.SET, _iter138.getValue().size()));
                for (Map.Entry<String, Set<String>> _iter139 : _iter138.getValue().entrySet())
                {
                  oprot.writeString(_iter139.getKey());
                  {
                    oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, _iter139.getValue().size()));
      ...
      if (struct.effectiveMetamodelExcludes != null) {
        if (struct.isSetEffectiveMetamodelExcludes()) {
          oprot.writeFieldBegin(EFFECTIVE_METAMODEL_EXCLUDES_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Map<String,Set<String>>> _iter141 : struct.effectiveMetamodelExcludes.entrySet())
            {
              oprot.writeString(_iter141.getKey());
              {
                oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.SET, _iter141.getValue().size()));
                for (Map.Entry<String, Set<String>> _iter142 : _iter141.getValue().entrySet())
                {
                  oprot.writeString(_iter142.getKey());
                  {
                    oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, _iter142.getValue().size()));
  ...
  private static class HawkQueryOptionsTupleScheme extends TupleScheme<HawkQueryOptions> {
      ...
      if (struct.isSetFilePatterns()) {
        {
          ...
          for (String _iter144 : struct.filePatterns)
          {
      ...
      if (struct.isSetEffectiveMetamodelIncludes()) {
        {
          ...
          for (Map.Entry<String, Map<String,Set<String>>> _iter145 : struct.effectiveMetamodelIncludes.entrySet())
          {
            oprot.writeString(_iter145.getKey());
            {
              oprot.writeI32(_iter145.getValue().size());
              for (Map.Entry<String, Set<String>> _iter146 : _iter145.getValue().entrySet())
              {
      ...
      if (struct.isSetEffectiveMetamodelExcludes()) {
        {
          ...
          for (Map.Entry<String, Map<String,Set<String>>> _iter148 : struct.effectiveMetamodelExcludes.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, HawkQueryOptions struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.filePatterns = new ArrayList<String>(_list151.size);
          String _elem152;
          for (int _i153 = 0; _i153 < _list151.size; ++_i153)
          {
            _elem152 = iprot.readString();
            struct.filePatterns.add(_elem152);
          }
        }
        struct.setFilePatternsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          org.apache.thrift.protocol.TMap _map154 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.MAP, iprot.readI32());
          struct.effectiveMetamodelIncludes = new HashMap<String,Map<String,Set<String>>>(2*_map154.size);
          String _key155;
          Map<String,Set<String>> _val156;
          for (int _i157 = 0; _i157 < _map154.size; ++_i157)
          {
            _key155 = iprot.readString();
            {
              org.apache.thrift.protocol.TMap _map158 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.SET, iprot.readI32());
              _val156 = new HashMap<String,Set<String>>(2*_map158.size);
              String _key159;
              Set<String> _val160;
              for (int _i161 = 0; _i161 < _map158.size; ++_i161)
              {
                ...
                {
                  org.apache.thrift.protocol.TSet _set162 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
                  _val160 = new HashSet<String>(2*_set162.size);
                  String _elem163;
            ...
            struct.effectiveMetamodelIncludes.put(_key155, _val156);
          }
        }
        struct.setEffectiveMetamodelIncludesIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.effectiveMetamodelExcludes = new HashMap<String,Map<String,Set<String>>>(2*_map165.size);
          String _key166;
          Map<String,Set<String>> _val167;
          for (int _i168 = 0; _i168 < _map165.size; ++_i168)
          {
            _key166 = iprot.readString();
            {
              org.apache.thrift.protocol.TMap _map169 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.SET, iprot.readI32());
              _val167 = new HashMap<String,Set<String>>(2*_map169.size);
              String _key170;
              Set<String> _val171;
              for (int _i172 = 0; _i172 < _map169.size; ++_i172)
              {
                _key170 = iprot.readString();
                {
                  ...
                  _val171 = new HashSet<String>(2*_set173.size);
                  String _elem174;
            ...
            struct.effectiveMetamodelExcludes.put(_key166, _val167);
          }
        }
        struct.setEffectiveMetamodelExcludesIsSet(true);
      }
