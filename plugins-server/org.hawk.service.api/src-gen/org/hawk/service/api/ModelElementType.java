            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<SlotMetadata>(_list90.size);
                SlotMetadata _elem91;
                for (int _i92 = 0; _i92 < _list90.size; ++_i92)
                {
                  _elem91 = new SlotMetadata();
                  _elem91.read(iprot);
                  struct.attributes.add(_elem91);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.references = new ArrayList<SlotMetadata>(_list93.size);
                SlotMetadata _elem94;
                for (int _i95 = 0; _i95 < _list93.size; ++_i95)
                {
                  _elem94 = new SlotMetadata();
                  _elem94.read(iprot);
                  struct.references.add(_elem94);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (SlotMetadata _iter96 : struct.attributes)
            {
              _iter96.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.references != null) {
        if (struct.isSetReferences()) {
          oprot.writeFieldBegin(REFERENCES_FIELD_DESC);
          {
            ...
            for (SlotMetadata _iter97 : struct.references)
            {
              _iter97.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (SlotMetadata _iter98 : struct.attributes)
          {
            _iter98.write(oprot);
          }
        }
      ...
      if (struct.isSetReferences()) {
        {
          ...
          for (SlotMetadata _iter99 : struct.references)
          {
            _iter99.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.attributes = new ArrayList<SlotMetadata>(_list100.size);
          SlotMetadata _elem101;
          for (int _i102 = 0; _i102 < _list100.size; ++_i102)
          {
            _elem101 = new SlotMetadata();
            _elem101.read(iprot);
            struct.attributes.add(_elem101);
          }
        }
        struct.setAttributesIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.references = new ArrayList<SlotMetadata>(_list103.size);
          SlotMetadata _elem104;
          for (int _i105 = 0; _i105 < _list103.size; ++_i105)
          {
            _elem104 = new SlotMetadata();
            _elem104.read(iprot);
            struct.references.add(_elem104);
          }
        }
        struct.setReferencesIsSet(true);
      }
