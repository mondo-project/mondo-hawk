            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<SlotMetadata>(_list72.size);
                SlotMetadata _elem73;
                for (int _i74 = 0; _i74 < _list72.size; ++_i74)
                {
                  _elem73 = new SlotMetadata();
                  _elem73.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.references = new ArrayList<SlotMetadata>(_list75.size);
                SlotMetadata _elem76;
                for (int _i77 = 0; _i77 < _list75.size; ++_i77)
                {
                  _elem76 = new SlotMetadata();
                  _elem76.read(iprot);
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (SlotMetadata _iter78 : struct.attributes)
            {
              _iter78.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.references != null) {
        if (struct.isSetReferences()) {
          oprot.writeFieldBegin(REFERENCES_FIELD_DESC);
          {
            ...
            for (SlotMetadata _iter79 : struct.references)
            {
              _iter79.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (SlotMetadata _iter80 : struct.attributes)
          {
            _iter80.write(oprot);
          }
        }
      ...
      if (struct.isSetReferences()) {
        {
          ...
          for (SlotMetadata _iter81 : struct.references)
          {
            _iter81.write(oprot);
          }
        }
