            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<AttributeSlot>(_list258.size);
                AttributeSlot _elem259;
                for (int _i260 = 0; _i260 < _list258.size; ++_i260)
                {
                  _elem259 = new AttributeSlot();
                  _elem259.read(iprot);
                  struct.attributes.add(_elem259);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.references = new ArrayList<ReferenceSlot>(_list261.size);
                ReferenceSlot _elem262;
                for (int _i263 = 0; _i263 < _list261.size; ++_i263)
                {
                  _elem262 = new ReferenceSlot();
                  _elem262.read(iprot);
                  struct.references.add(_elem262);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.containers = new ArrayList<ContainerSlot>(_list264.size);
                ContainerSlot _elem265;
                for (int _i266 = 0; _i266 < _list264.size; ++_i266)
                {
                  _elem265 = new ContainerSlot();
                  _elem265.read(iprot);
                  struct.containers.add(_elem265);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (AttributeSlot _iter267 : struct.attributes)
            {
      ...
      if (struct.references != null) {
        if (struct.isSetReferences()) {
          oprot.writeFieldBegin(REFERENCES_FIELD_DESC);
          {
            ...
            for (ReferenceSlot _iter268 : struct.references)
            {
      ...
      if (struct.containers != null) {
        if (struct.isSetContainers()) {
          oprot.writeFieldBegin(CONTAINERS_FIELD_DESC);
          {
            ...
            for (ContainerSlot _iter269 : struct.containers)
            {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (AttributeSlot _iter270 : struct.attributes)
          {
      ...
      if (struct.isSetReferences()) {
        {
          ...
          for (ReferenceSlot _iter271 : struct.references)
          {
      ...
      if (struct.isSetContainers()) {
        {
          ...
          for (ContainerSlot _iter272 : struct.containers)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.attributes = new ArrayList<AttributeSlot>(_list273.size);
          AttributeSlot _elem274;
          for (int _i275 = 0; _i275 < _list273.size; ++_i275)
          {
            _elem274 = new AttributeSlot();
            _elem274.read(iprot);
            struct.attributes.add(_elem274);
          }
        }
        struct.setAttributesIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.references = new ArrayList<ReferenceSlot>(_list276.size);
          ReferenceSlot _elem277;
          for (int _i278 = 0; _i278 < _list276.size; ++_i278)
          {
            _elem277 = new ReferenceSlot();
            _elem277.read(iprot);
            struct.references.add(_elem277);
          }
        }
        struct.setReferencesIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.containers = new ArrayList<ContainerSlot>(_list279.size);
          ContainerSlot _elem280;
          for (int _i281 = 0; _i281 < _list279.size; ++_i281)
          {
            _elem280 = new ContainerSlot();
            _elem280.read(iprot);
            struct.containers.add(_elem280);
          }
        }
        struct.setContainersIsSet(true);
      }
