            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<AttributeSlot>(_list224.size);
                AttributeSlot _elem225;
                for (int _i226 = 0; _i226 < _list224.size; ++_i226)
                {
                  _elem225 = new AttributeSlot();
                  _elem225.read(iprot);
                  struct.attributes.add(_elem225);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.references = new ArrayList<ReferenceSlot>(_list227.size);
                ReferenceSlot _elem228;
                for (int _i229 = 0; _i229 < _list227.size; ++_i229)
                {
                  _elem228 = new ReferenceSlot();
                  _elem228.read(iprot);
                  struct.references.add(_elem228);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.containers = new ArrayList<ContainerSlot>(_list230.size);
                ContainerSlot _elem231;
                for (int _i232 = 0; _i232 < _list230.size; ++_i232)
                {
                  _elem231 = new ContainerSlot();
                  _elem231.read(iprot);
                  struct.containers.add(_elem231);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (AttributeSlot _iter233 : struct.attributes)
            {
      ...
      if (struct.references != null) {
        if (struct.isSetReferences()) {
          oprot.writeFieldBegin(REFERENCES_FIELD_DESC);
          {
            ...
            for (ReferenceSlot _iter234 : struct.references)
            {
      ...
      if (struct.containers != null) {
        if (struct.isSetContainers()) {
          oprot.writeFieldBegin(CONTAINERS_FIELD_DESC);
          {
            ...
            for (ContainerSlot _iter235 : struct.containers)
            {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (AttributeSlot _iter236 : struct.attributes)
          {
      ...
      if (struct.isSetReferences()) {
        {
          ...
          for (ReferenceSlot _iter237 : struct.references)
          {
      ...
      if (struct.isSetContainers()) {
        {
          ...
          for (ContainerSlot _iter238 : struct.containers)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.attributes = new ArrayList<AttributeSlot>(_list239.size);
          AttributeSlot _elem240;
          for (int _i241 = 0; _i241 < _list239.size; ++_i241)
          {
            _elem240 = new AttributeSlot();
            _elem240.read(iprot);
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.references = new ArrayList<ReferenceSlot>(_list242.size);
          ReferenceSlot _elem243;
          for (int _i244 = 0; _i244 < _list242.size; ++_i244)
          {
            _elem243 = new ReferenceSlot();
            _elem243.read(iprot);
            struct.references.add(_elem243);
          }
        }
        struct.setReferencesIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.containers = new ArrayList<ContainerSlot>(_list245.size);
          ContainerSlot _elem246;
          for (int _i247 = 0; _i247 < _list245.size; ++_i247)
          {
            _elem246 = new ContainerSlot();
            _elem246.read(iprot);
            struct.containers.add(_elem246);
          }
        }
        struct.setContainersIsSet(true);
      }
