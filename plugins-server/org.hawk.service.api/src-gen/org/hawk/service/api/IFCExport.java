              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<IFCExportJob>(_list434.size);
                  IFCExportJob _elem435;
                  for (int _i436 = 0; _i436 < _list434.size; ++_i436)
                  {
                    _elem435 = new IFCExportJob();
                    _elem435.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getJobs_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (IFCExportJob _iter437 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (IFCExportJob _iter438 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<IFCExportJob>(_list439.size);
            IFCExportJob _elem440;
            for (int _i441 = 0; _i441 < _list439.size; ++_i441)
            {
              _elem440 = new IFCExportJob();
              _elem440.read(iprot);
