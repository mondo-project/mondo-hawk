              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<IFCExportJob>(_list424.size);
                  IFCExportJob _elem425;
                  for (int _i426 = 0; _i426 < _list424.size; ++_i426)
                  {
                    _elem425 = new IFCExportJob();
                    _elem425.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getJobs_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (IFCExportJob _iter427 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (IFCExportJob _iter428 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<IFCExportJob>(_list429.size);
            IFCExportJob _elem430;
            for (int _i431 = 0; _i431 < _list429.size; ++_i431)
            {
              _elem430 = new IFCExportJob();
              _elem430.read(iprot);
