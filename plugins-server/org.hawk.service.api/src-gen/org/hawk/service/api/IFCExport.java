              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<IFCExportJob>(_list442.size);
                  IFCExportJob _elem443;
                  for (int _i444 = 0; _i444 < _list442.size; ++_i444)
                  {
                    _elem443 = new IFCExportJob();
                    _elem443.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getJobs_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (IFCExportJob _iter445 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (IFCExportJob _iter446 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<IFCExportJob>(_list447.size);
            IFCExportJob _elem448;
            for (int _i449 = 0; _i449 < _list447.size; ++_i449)
            {
              _elem448 = new IFCExportJob();
              _elem448.read(iprot);
