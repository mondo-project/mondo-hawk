              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<IFCExportJob>(_list458.size);
                  IFCExportJob _elem459;
                  for (int _i460 = 0; _i460 < _list458.size; ++_i460)
                  {
                    _elem459 = new IFCExportJob();
                    _elem459.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getJobs_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (IFCExportJob _iter461 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (IFCExportJob _iter462 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<IFCExportJob>(_list463.size);
            IFCExportJob _elem464;
            for (int _i465 = 0; _i465 < _list463.size; ++_i465)
            {
              _elem464 = new IFCExportJob();
              _elem464.read(iprot);
