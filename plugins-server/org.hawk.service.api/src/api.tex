...
\begin{longtable} {|p{2cm}|p{3.5cm}|p{2.5cm}|p{6.5cm}|}
	\caption{Operation OfflineCollaboration.listGoldRepositories}
	\label{tab:offlineCollaboration-listGoldRepositories}\\
	\cline{2-4}%
	\multicolumn{1}{c|}{} & \textbf{Name} & \textbf{Type} & \textbf{Documentation} \\\hline 
	\textbf{Operation} & \camelcase{listGoldRepositories} & \camelcase{list<string>} & Retrieve the list of all managed gold repositories. \\\hline
	\textbf{Parameters} & \multicolumn{3}{l|}{None.} \\\hline
	\textbf{Exceptions} & \multicolumn{3}{l|}{} \\\hline
	 & \camelcase{UnauthorizedRepositoryOperation} & \multicolumn{2}{p{8.5cm}|}{Authenticated user is not permitted to carry out the requested operation on the specified repository.} \\\hline 
	 & \camelcase{OfflineCollaborationInternalError} & \multicolumn{2}{p{8.5cm}|}{An internal error occurred on the collaboration server. See details in server log.} \\\hline 
\end{longtable}
\begin{longtable} {|p{2cm}|p{3.5cm}|p{2.5cm}|p{6.5cm}|}
	...
	\cline{2-4}%
	\multicolumn{1}{c|}{} & \textbf{Name} & \textbf{Type} & \textbf{Documentation} \\\hline 
	\textbf{Operation} & \camelcase{regenerateFrontRepositories} & \camelcase{void} & Regenerate all front repositories based on the gold repository. Requires superuser privileges. \\\hline
	\textbf{Parameters} & \multicolumn{3}{l|}{} \\\hline
	 & goldRepoURL & \camelcase{string} & URL of the gold repository. \\\hline 
	\textbf{Exceptions} & \multicolumn{3}{l|}{} \\\hline
	 & \camelcase{GoldRepoNotFound} & \multicolumn{2}{p{8.5cm}|}{No gold repository is configured at the specified URL.} \\\hline 
	 & \camelcase{UnauthorizedRepositoryOperation} & \multicolumn{2}{p{8.5cm}|}{Authenticated user is not permitted to carry out the requested operation on the specified repository.} \\\hline 
	 & \camelcase{OfflineCollaborationInternalError} & \multicolumn{2}{p{8.5cm}|}{An internal error occurred on the collaboration server. See details in server log.} \\\hline 
\end{longtable}
\begin{longtable} {|p{2cm}|p{3.5cm}|p{2.5cm}|p{6.5cm}|}
	...
	\cline{2-4}%
	\multicolumn{1}{c|}{} & \textbf{Name} & \textbf{Type} & \textbf{Documentation} \\\hline 
	\textbf{Operation} & \camelcase{getMyFrontRepositoryURL} & \camelcase{string} & Retrieve the front repository URL for the current user. \\\hline
	\textbf{Parameters} & \multicolumn{3}{l|}{} \\\hline
	 & goldRepoURL & \camelcase{string} & URL of the gold repository. \\\hline 
	\textbf{Exceptions} & \multicolumn{3}{l|}{} \\\hline
	 & \camelcase{GoldRepoNotFound} & \multicolumn{2}{p{8.5cm}|}{No gold repository is configured at the specified URL.} \\\hline 
...
\end{longtable}
\begin{longtable} {|p{2cm}|p{3.5cm}|p{2.5cm}|p{6.5cm}|}
	\caption{Operation OfflineCollaboration.getOnlineCollaborationURL}
	\label{tab:offlineCollaboration-getOnlineCollaborationURL}\\
	\cline{2-4}%
	\multicolumn{1}{c|}{} & \textbf{Name} & \textbf{Type} & \textbf{Documentation} \\\hline 
	\textbf{Operation} & \camelcase{getOnlineCollaborationURL} & \camelcase{string} & Retrieve the online collaboration access point URL for the current user. \\\hline
	\textbf{Parameters} & \multicolumn{3}{l|}{} \\\hline
	 & goldRepoURL & \camelcase{string} & URL of the gold repository. \\\hline 
	\textbf{Exceptions} & \multicolumn{3}{l|}{} \\\hline
	 & \camelcase{GoldRepoNotFound} & \multicolumn{2}{p{8.5cm}|}{No gold repository is configured at the specified URL.} \\\hline 
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
   ...
   \multicolumn{3}{|p{.95\linewidth}|}{\textbf{Used in:} Hawk.query} \\\hline
\end{longtable}
\subsubsection{GoldRepoNotFound}
No gold repository is configured at the specified URL.

\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	\caption{Exception GoldRepoNotFound}
	\label{tab:goldRepoNotFound}\\
	\hline%
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
	    --- & --- & --- \\\hline
   \multicolumn{3}{|p{.95\linewidth}|}{\textbf{Used in:} OfflineCollaboration.regenerateFrontRepositories, OfflineCollaboration.getMyFrontRepositoryURL, OfflineCollaboration.getOnlineCollaborationURL} \\\hline
\end{longtable}
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
   ...
   \multicolumn{3}{|p{.95\linewidth}|}{\textbf{Used in:} CloudATL.launch} \\\hline
\end{longtable}
\subsubsection{OfflineCollaborationInternalError}
An internal error occurred on the collaboration server. See details in server log.

\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	\caption{Exception OfflineCollaborationInternalError}
	\label{tab:offlineCollaborationInternalError}\\
	\hline%
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
		  \camelcase{errorMessage}  & \camelcase{string}  & Summary description of the error. See details in server log. \\\hline
   \multicolumn{3}{|p{.95\linewidth}|}{\textbf{Used in:} OfflineCollaboration.listGoldRepositories, OfflineCollaboration.regenerateFrontRepositories, OfflineCollaboration.getMyFrontRepositoryURL, OfflineCollaboration.getOnlineCollaborationURL} \\\hline
\end{longtable}
...
\end{longtable}
\subsubsection{UnauthorizedRepositoryOperation}
Authenticated user is not permitted to carry out the requested operation on the specified repository.

\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	\caption{Exception UnauthorizedRepositoryOperation}
	\label{tab:unauthorizedRepositoryOperation}\\
	\hline%
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
	    --- & --- & --- \\\hline
   \multicolumn{3}{|p{.95\linewidth}|}{\textbf{Used in:} OfflineCollaboration.listGoldRepositories, OfflineCollaboration.regenerateFrontRepositories, OfflineCollaboration.getMyFrontRepositoryURL, OfflineCollaboration.getOnlineCollaborationURL} \\\hline
