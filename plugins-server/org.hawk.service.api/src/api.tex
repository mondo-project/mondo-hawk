...
\end{longtable}
\begin{longtable} {|p{2cm}|p{3.5cm}|p{2.5cm}|p{6.5cm}|}
	\caption{Operation Hawk.listMetamodelParsers}
	\label{tab:hawk-listMetamodelParsers}\\
	\cline{2-4}%
	\multicolumn{1}{c|}{} & \textbf{Name} & \textbf{Type} & \textbf{Documentation} \\\hline 
	\textbf{Operation} & \camelcase{listMetamodelParsers} & \camelcase{list<MetamodelParserDetails>} & Lists the details of the metamodel parsers in a Hawk instance. \\\hline
	\textbf{Parameters} & \multicolumn{3}{l|}{} \\\hline
	 & name & \camelcase{string} & The name of the Hawk instance. \\\hline 
	\textbf{Exceptions} & \multicolumn{3}{l|}{} \\\hline
	 & \camelcase{HawkInstanceNotFound} & \multicolumn{2}{p{8.5cm}|}{No Hawk instance exists with that name.} \\\hline 
...
\end{longtable}
\begin{longtable} {|p{2cm}|p{3.5cm}|p{2.5cm}|p{6.5cm}|}
	\caption{Operation Hawk.timedQuery}
	\label{tab:hawk-timedQuery}\\
	\cline{2-4}%
	\multicolumn{1}{c|}{} & \textbf{Name} & \textbf{Type} & \textbf{Documentation} \\\hline 
	\textbf{Operation} & \camelcase{timedQuery} & \camelcase{QueryReport} & Runs a query on a Hawk instance and returns a sequence of scalar values and/or model elements. \\\hline
	\textbf{Parameters} & \multicolumn{3}{l|}{} \\\hline
	 & name & \camelcase{string} & The name of the Hawk instance. \\\hline 
	 & query & \camelcase{string} & The query to be executed. \\\hline 
	 & language & \camelcase{string} & The name of the query language used (e.g. EOL, OCL). \\\hline 
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
   ...
   \multicolumn{3}{|p{.95\linewidth}|}{\textbf{Used in:} HawkQueryOptions} \\\hline
\end{longtable}
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
   ...
   \multicolumn{3}{|p{.95\linewidth}|}{\textbf{Used in:} Hawk.query, Hawk.timedQuery, Hawk.resolveProxies, Hawk.getModel, Hawk.getRootElements} \\\hline
\end{longtable}
...
\subsubsection{MetamodelParserDetails}

Details for a metamodel registered in a Hawk instance.

\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	\caption{Structure MetamodelParserDetails}
	\label{tab:metamodelParserDetails}\\
	\hline%
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
		  \camelcase{fileExtensions}  & \camelcase{set<string>}  & Recognised file extensions, starting with '.'. \\\hline
		  \camelcase{identifier}  & \camelcase{string}  & Type identifier. \\\hline
   \multicolumn{3}{|p{.95\linewidth}|}{\textbf{Used in:} Hawk.listMetamodelParsers} \\\hline
\end{longtable}
...
\subsubsection{QueryReport}

Report from a query, including execution time and any other information we may consider later.

\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	\caption{Structure QueryReport}
	\label{tab:queryReport}\\
	\hline%
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
		  \camelcase{result}  & \camelcase{QueryResult}  & Result of the query. \\\hline
		  \camelcase{wallMillis}  & \camelcase{i64}  & Wall time on the server in milliseconds. \\\hline
   \multicolumn{3}{|p{.95\linewidth}|}{\textbf{Used in:} Hawk.timedQuery} \\\hline
\end{longtable}
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
   ...
   \multicolumn{3}{|p{.95\linewidth}|}{\textbf{Used in:} Hawk.query, QueryResult, QueryReport, QueryResultMap} \\\hline
\end{longtable}
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	...
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
		  ...
		  \camelcase{vLists}  & \camelcase{list<SlotValue>}  & List of lists. \\\hline
		  \camelcase{vLong}  (\nohyphens{inherited}) & \camelcase{i64}  & 64-bit signed integer value. \\\hline
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
   ...
   \multicolumn{3}{|p{.95\linewidth}|}{\textbf{Used in:} Hawk.query, Hawk.timedQuery} \\\hline
\end{longtable}
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	...
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
	    --- & --- & --- \\\hline
   \multicolumn{3}{|p{.95\linewidth}|}{\textbf{Used in:} Hawk.removeInstance, Hawk.startInstance, Hawk.stopInstance, Hawk.syncInstance, Hawk.registerMetamodels, Hawk.unregisterMetamodels, Hawk.listMetamodels, Hawk.listMetamodelParsers, Hawk.query, Hawk.timedQuery, Hawk.resolveProxies, Hawk.addRepository, Hawk.isFrozen, Hawk.setFrozen, Hawk.removeRepository, Hawk.updateRepositoryCredentials, Hawk.listRepositories, Hawk.listFiles, Hawk.configurePolling, Hawk.addDerivedAttribute, Hawk.removeDerivedAttribute, Hawk.listDerivedAttributes, Hawk.addIndexedAttribute, Hawk.removeIndexedAttribute, Hawk.listIndexedAttributes, Hawk.getModel, Hawk.watchStateChanges, Hawk.watchModelChanges} \\\hline
\end{longtable}
