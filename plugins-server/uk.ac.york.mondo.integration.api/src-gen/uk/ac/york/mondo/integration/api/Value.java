...
public class Value extends org.apache.thrift.TUnion<Value, Value._Fields> {
  ...
  public static Value vShort(short value) {
    Value x = new Value();
    x.setVShort(value);
    return x;
  }

  public static Value vInteger(int value) {
    Value x = new Value();
    x.setVInteger(value);
    return x;
  }

  public static Value vLong(long value) {
    Value x = new Value();
    x.setVLong(value);
    return x;
  }

  public static Value vDouble(double value) {
    Value x = new Value();
    x.setVDouble(value);
    return x;
  }

  public static Value vString(String value) {
    Value x = new Value();
    x.setVString(value);
    return x;
  }
