...
public class AbstractConsoleImpl implements IAbstractConsole {
	 ...
	 * @param name
	 */
	public AbstractConsoleImpl(String name) {
		...
		if (console.getBackground() != null
			...
			out = newPrintStream((PlatformUI.getWorkbench().getDisplay()
					.getSystemColor(SWT.COLOR_WHITE)));
		else
			out = newPrintStream((PlatformUI.getWorkbench().getDisplay()
					.getSystemColor(SWT.COLOR_BLACK)));

		err = newPrintStream((PlatformUI.getWorkbench().getDisplay()
