...
import org.hawk.mondix.query.HawkMetamodelQueryInstance;
 ...
 * 
 */
public class HawkMetamodelMondixRelation implements IMondixRelation {

	// TODO hint/prepare frequently filtered columns

	private HawkMondixInstance hawk;

	public HawkMetamodelMondixRelation(HawkMondixInstance hawkMondixInstance) {
	...
	public HawkQueryInstance openView(
		...
		return new HawkMetamodelQueryInstance(hawk.getGraph(),
