...
import org.hawk.mondix.query.HawkFileQueryInstance;
 ...
 * 
 */
public class HawkFileMondixRelation implements IMondixRelation {

	HawkMondixInstance hawk;

	public HawkFileMondixRelation(HawkMondixInstance hawkMondixInstance) {
	...
	public HawkQueryInstance openView(
		...
		return new HawkFileQueryInstance(hawk.getGraph(), selectedColumnNames,
				filter, this);
	}
